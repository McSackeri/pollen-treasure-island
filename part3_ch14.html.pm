...
◊img[#:src "/images/0140m.jpg"]{}

◊img[#:src "/images/9140m.jpg" #:alt "I" #:class "drop-cap"]{} WAS so pleased at having given the slip to Long John that I began to enjoy myself and look around me with some interest on the strange land that I was in.
...
◊dialog{"John!"} said the sailor, stretching out his hand.

◊dialog{"Hands off!"} cried Silver, leaping back a yard, as it seemed to me, with the speed and security of a trained gymnast.

◊dialog{"Hands off, if you like, John Silver,"} said the other. ◊dialog{"It's a black conscience that can make you feared of me. But in heaven's name, tell me, what was that?"}

◊dialog{"That?"} returned Silver, smiling away, but warier than ever, his eye a mere pin-point in his big face, but gleaming like a crumb of glass. ◊dialog{"That? Oh, I reckon that'll be Alan."}

And at this point Tom flashed out like a hero.

◊dialog{"Alan!"} he cried. ◊dialog{"Then rest his soul for a true seaman! And as for you, John Silver, long you've been a mate of mine, but you're mate of mine no more. If I die like a dog, I'll die in my dooty. You've killed Alan, have you? Kill me too, if you can. But I defies you."}
...
◊img[#:src "/images/0141m.jpg"]{}
◊img[#:src "/images/0145m.jpg"]{}
