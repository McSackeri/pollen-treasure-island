...
◊img[#:src "/images/0190m.jpg"]{}

◊img[#:src "/images/9190m.jpg" #:alt "S" #:class "drop-cap"]{}URE enough, there were two men just outside the stockade, one of them waving a white cloth, the other, no less a person than Silver himself, standing placidly by.
...
◊dialog{"Keep indoors, men,"} said the captain. ◊dialog{"Ten to one this is a trick."}

Then he hailed the buccaneer.

◊dialog{"Who goes? Stand, or we fire."}

◊dialog{"Flag of truce,"} cried Silver.

The captain was in the porch, keeping himself carefully out of the way of a treacherous shot, should any be intended. He turned and spoke to us, ◊dialog{"Doctor's watch on the lookout. Dr. Livesey take the north side, if you please; Jim, the east; Gray, west. The watch below, all hands to load muskets. Lively, men, and careful."}

And then he turned again to the mutineers.

◊dialog{"And what do you want with your flag of truce?"} he cried.

This time it was the other man who replied.

◊dialog{"Cap'n Silver, sir, to come on board and make terms,"} he shouted.

◊dialog{"Cap'n Silver! Don't know him. Who's he?"} cried the captain. And we could hear him adding to himself, ◊dialog{"Cap'n, is it? My heart, and here's promotion!"}

Long John answered for himself. ◊dialog{"Me, sir. These poor lads have chosen me cap'n, after your desertion, sir"}--laying a particular emphasis upon the word ◊dialog{"desertion."} ◊dialog{"We're willing to submit, if we can come to terms, and no bones about it. All I ask is your word, Cap'n Smollett, to let me safe and sound out of this here stockade, and one minute to get out o' shot before a gun is fired."}

◊dialog{"My man,"} said Captain Smollett, ◊dialog{"I have not the slightest desire to talk to you. If you wish to talk to me, you can come, that's all. If there's any treachery, it'll be on your side, and the Lord help you."}

◊dialog{"That's enough, cap'n,"} shouted Long John cheerily. ◊dialog{"A word from you's enough. I know a gentleman, and you may lay to that."}
...
I will confess that I was far too much taken up with what was going on to be of the slightest use as sentry; indeed, I had already deserted my eastern loophole and crept up behind the captain, who had now seated himself on the threshold, with his elbows on his knees, his head in his hands, and his eyes fixed on the water as it bubbled out of the old iron kettle in the sand. He was whistling ◊dialog{"Come, Lasses and Lads."}
...
◊dialog{"Here you are, my man,"} said the captain, raising his head. ◊dialog{"You had better sit down."}

◊dialog{"You ain't a-going to let me inside, cap'n?"} complained Long John. ◊dialog{"It's a main cold morning, to be sure, sir, to sit outside upon the sand."}

◊dialog{"Why, Silver,"} said the captain, ◊dialog{"if you had pleased to be an honest man, you might have been sitting in your galley. It's your own doing. You're either my ship's cook--and then you were treated handsome--or Cap'n Silver, a common mutineer and pirate, and then you can go hang!"}
...
◊dialog{"Well, here it is,"} said Silver. ◊dialog{"We want that treasure, and we'll have it--that's our point! You would just as soon save your lives, I reckon; and that's yours. You have a chart, haven't you?"}

◊dialog{"That's as may be,"} replied the captain.

◊dialog{"Oh, well, you have, I know that,"} returned Long John. ◊dialog{"You needn't be so husky with a man; there ain't a particle of service in that, and you may lay to it. What I mean is, we want your chart. Now, I never meant you no harm, myself."}

◊dialog{"That won't do with me, my man,"} interrupted the captain. ◊dialog{"We know exactly what you meant to do, and we don't care, for now, you see, you can't do it."}

And the captain looked at him calmly and proceeded to fill a pipe.

◊dialog{"If Abe Gray--"} Silver broke out.

◊dialog{"Avast there!"} cried Mr. Smollett. ◊dialog{"Gray told me nothing, and I asked him nothing; and what's more, I would see you and him and this whole island blown clean out of the water into blazes first. So there's my mind for you, my man, on that."}
...
◊dialog{"Like enough,"} said he. ◊dialog{"I would set no limits to what gentlemen might consider shipshape, or might not, as the case were. And seein' as how you are about to take a pipe, cap'n, I'll make so free as do likewise."}
...
◊dialog{"There!"} he cried. ◊dialog{"That's what I think of ye. Before an hour's out, I'll stove in your old block house like a rum puncheon. Laugh, by thunder, laugh! Before an hour's out, ye'll laugh upon the other side. Them that die'll be the lucky ones."}
