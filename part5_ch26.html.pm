...
◊img[#:src "/images/0241m.png"]{}

◊img[#:src "/images/9241m.png" #:alt "T" #:class "drop-cap"]{}HE wind, serving us to a desire, now hauled into the west. We could run so much the easier from the north-east corner of the island to the mouth of the North Inlet. Only, as we had no power to anchor and dared not beach her till the tide had flowed a good deal farther, time hung on our hands. The coxswain told me how to lay the ship to; after a good many trials I succeeded, and we both sat in silence over another meal.
...
◊dialog{"Some wine?"} I said. ◊dialog{"Far better. Will you have white or red?"}

◊dialog{"Well, I reckon it's about the blessed same to me, shipmate,"} he replied; ◊dialog{"so it's strong, and plenty of it, what's the odds?"}

◊dialog{"All right,"} I answered. ◊dialog{"I'll bring you port, Mr. Hands. But I'll have to dig for it."}
...
Hands lay as I had left him, all fallen together in a bundle and with his eyelids lowered as though he were too weak to bear the light. He looked up, however, at my coming, knocked the neck off the bottle like a man who had done the same thing often, and took a good swig, with his favourite toast of ◊dialog{"Here's luck!"} Then he lay quiet for a little, and then, pulling out a stick of tobacco, begged me to cut him a quid.

◊dialog{"Cut me a junk o' that,"} says he, ◊dialog{"for I haven't no knife and hardly strength enough, so be as I had. Ah, Jim, Jim, I reckon I've missed stays! Cut me a quid, as'll likely be the last, lad, for I'm for my long home, and no mistake."}

◊dialog{"Well,"} said I, ◊dialog{"I'll cut you some tobacco, but if I was you and thought myself so badly, I would go to my prayers like a Christian man."}

◊dialog{"Why?"} said he. ◊dialog{"Now, you tell me why."}

◊dialog{"Why?"} I cried. ◊dialog{"You were asking me just now about the dead. You've broken your trust; you've lived in sin and lies and blood; there's a man you killed lying at your feet this moment, and you ask me why! For God's mercy, Mr. Hands, that's why."}
...
◊dialog{"Now,"} said Hands, ◊dialog{"look there; there's a pet bit for to beach a ship in. Fine flat sand, never a cat's paw, trees all around of it, and flowers a-blowing like a garding on that old ship."}

◊dialog{"And once beached,"} I inquired, ◊dialog{"how shall we get her off again?"}

◊dialog{"Why, so,"} he replied: ◊dialog{"you take a line ashore there on the other side at low water, take a turn about one of them big pines; bring it back, take a turn around the capstan, and lie to for the tide. Come high water, all hands take a pull upon the line, and off she comes as sweet as natur'. And now, boy, you stand by. We're near the bit now, and she's too much way on her. Starboard a little--so--steady--starboard--larboard a little--steady--steady!"}

So he issued his commands, which I breathlessly obeyed, till, all of a sudden, he cried, ◊dialog{"Now, my hearty, luff!"} And I put the helm hard up, and the HISPANIOLA swung round rapidly and ran stem on for the low, wooded shore.
...
◊dialog{"One more step, Mr. Hands,"} said I, ◊dialog{"and I'll blow your brains out! Dead men don't bite, you know,"} I added with a chuckle.
...
◊dialog{"Jim,"} says he, ◊dialog{"I reckon we're fouled, you and me, and we'll have to sign articles. I'd have had you but for that there lurch, but I don't have no luck, not I; and I reckon I'll have to strike, which comes hard, you see, for a master mariner to a ship's younker like you, Jim."}
...
◊img[#:src "/images/0219m.jpg" #:class "ovrly-image"]{}
◊img[#:src "/images/0247m.png"]{}
}
