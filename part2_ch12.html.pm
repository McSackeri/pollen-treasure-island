...
◊a[#:href "/images/0122.jpg"]{◊img[#:class "chapter-img" #:src "/images/0122m.png"]{}}

◊a[#:href "/images/9122.jpg"]{◊img[#:src "/images/9122m.png" #:alt "T" #:class "drop-cap"]{}}HERE was a great rush of feet across the deck. I could hear people tumbling up from the cabin and the forecastle, and slipping in an instant outside my barrel, I dived behind the fore-sail, made a double towards the stern, and came out upon the open deck in time to join Hunter and Dr. Livesey in the rush for the weather bow.
...
◊dialog{"And now, men,"} said the captain, when all was sheeted home, ◊dialog{"has any one of you ever seen that land ahead?"}

◊dialog{"I have, sir,"} said Silver. ◊dialog{"I've watered there with a trader I was cook in."}

◊dialog{"The anchorage is on the south, behind an islet, I fancy?"} asked the captain.

◊dialog{"Yes, sir; Skeleton Island they calls it. It were a main place for pirates once, and a hand we had on board knowed all their names for it. That hill to the nor'ard they calls the Fore-mast Hill; there are three hills in a row running south'ard--fore, main, and mizzen, sir. But the main--that's the big un, with the cloud on it--they usually calls the Spy-glass, by reason of a lookout they kept when they was in the anchorage cleaning, for it's there they cleaned their ships, sir, asking your pardon."}

◊dialog{"I have a chart here,"} says Captain Smollett. ◊dialog{"See if that's the place."}
...
◊dialog{"Yes, sir,"} said he, ◊dialog{"this is the spot, to be sure, and very prettily drawed out. Who might have done that, I wonder? The pirates were too ignorant, I reckon. Aye, here it is: 'Capt. Kidd's Anchorage'--just the name my shipmate called it. There's a strong current runs along the south, and then away nor'ard up the west coast. Right you was, sir,"} says he, ◊dialog{"to haul your wind and keep the weather of the island. Leastways, if such was your intention as to enter and careen, and there ain't no better place for that in these waters."}

◊dialog{"Thank you, my man,"} says Captain Smollett. ◊dialog{"I'll ask you later on to give us a help. You may go."}
...
◊a[#:href "/images/0125.jpg"]{◊img[#:class "chapter-img" #:src "/images/0125m.png"]{}}
...
◊dialog{"Now, Hawkins,"} said the squire, ◊dialog{"you have something to say. Speak up."}
...
◊dialog{"Jim,"} said Dr. Livesey, ◊dialog{"take a seat."}
...
◊dialog{"Now, captain,"} said the squire, ◊dialog{"you were right, and I was wrong. I own myself an ass, and I await your orders."}

◊dialog{"No more an ass than I, sir,"} returned the captain. ◊dialog{"I never heard of a crew that meant to mutiny but what showed signs before, for any man that had an eye in his head to see the mischief and take steps according. But this crew,"} he added, ◊dialog{"beats me."}

◊dialog{"Captain,"} said the doctor, ◊dialog{"with your permission, that's Silver. A very remarkable man."}

◊dialog{"He'd look remarkably well from a yard-arm, sir,"} returned the captain. ◊dialog{"But this is talk; this don't lead to anything. I see three or four points, and with Mr. Trelawney's permission, I'll name them."}

◊dialog{"You, sir, are the captain. It is for you to speak,"} says Mr. Trelawney grandly.

◊dialog{"First point,"} began Mr. Smollett. ◊dialog{"We must go on, because we can't turn back. If I gave the word to go about, they would rise at once. Second point, we have time before us--at least until this treasure's found. Third point, there are faithful hands. Now, sir, it's got to come to blows sooner or later, and what I propose is to take time by the forelock, as the saying is, and come to blows some fine day when they least expect it. We can count, I take it, on your own home servants, Mr. Trelawney?"}

◊dialog{"As upon myself,"} declared the squire.

◊dialog{"Three,"} reckoned the captain; ◊dialog{"ourselves make seven, counting Hawkins here. Now, about the honest hands?"}

◊dialog{"Most likely Trelawney's own men,"} said the doctor; ◊dialog{"those he had picked up for himself before he lit on Silver."}

◊dialog{"Nay,"} replied the squire. ◊dialog{"Hands was one of mine."}

◊dialog{"I did think I could have trusted Hands,"} added the captain.

◊dialog{"And to think that they're all Englishmen!"} broke out the squire. ◊dialog{"Sir, I could find it in my heart to blow the ship up."}

◊dialog{"Well, gentlemen,"} said the captain, ◊dialog{"the best that I can say is not much. We must lay to, if you please, and keep a bright lookout. It's trying on a man, I know. It would be pleasanter to come to blows. But there's no help for it till we know our men. Lay to, and whistle for a wind, that's my view."}

◊dialog{"Jim here,"} said the doctor, ◊dialog{"can help us more than anyone. The men are not shy with him, and Jim is a noticing lad."}

◊dialog{"Hawkins, I put prodigious faith in you,"} added the squire.
