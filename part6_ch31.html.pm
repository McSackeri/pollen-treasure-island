...
◊dialog{"Aye, mates,"} said he, ◊dialog{"it's lucky you have Barbecue to think for you with this here head. I got what I wanted, I did. Sure enough, they have the ship. Where they have it, I don't know yet; but once we hit the treasure, we'll have to jump about and find out. And then, mates, us that has the boats, I reckon, has the upper hand."}
...
Add to this double apprehension the mystery that still hung over the behaviour of my friends, their unexplained desertion of the stockade, their inexplicable cession of the chart, or harder still to understand, the doctor's last warning to Silver, ◊dialog{"Look out for squalls when you find it,"} and you will readily believe how little taste I found in my breakfast and with how uneasy a heart I set forth behind my captors on the quest for treasure.
...
As we pulled over, there was some discussion on the chart. The red cross was, of course, far too large to be a guide; and the terms of the note on the back, as you will hear, admitted of some ambiguity. They ran, the reader may remember, thus:
     ...
     ◊note{Tall tree, Spy-glass shoulder, bearing a point to
     the N. of N.N.E.
...
◊dialog{"He can't 'a found the treasure,"} said old Morgan, hurrying past us from the right, ◊dialog{"for that's clean a-top."}
...
◊dialog{"He was a seaman,"} said George Merry, who, bolder than the rest, had gone up close and was examining the rags of clothing. ◊dialog{"Leastways, this is good sea-cloth."}

◊dialog{"Aye, aye,"} said Silver; ◊dialog{"like enough; you wouldn't look to find a bishop here, I reckon. But what sort of a way is that for bones to lie? 'Tain't in natur'."}
...
◊dialog{"I've taken a notion into my old numbskull,"} observed Silver. ◊dialog{"Here's the compass; there's the tip-top p'int o' Skeleton Island, stickin' out like a tooth. Just take a bearing, will you, along the line of them bones."}

It was done. The body pointed straight in the direction of the island, and the compass read duly E.S.E. and by E.

◊dialog{"I thought so,"} cried the cook; ◊dialog{"this here is a p'inter. Right up there is our line for the Pole Star and the jolly dollars. But, by thunder! If it don't make me cold inside to think of Flint. This is one of HIS jokes, and no mistake. Him and these six was alone here; he killed 'em, every man; and this one he hauled here and laid down by compass, shiver my timbers! They're long bones, and the hair's been yellow. Aye, that would be Allardyce. You mind Allardyce, Tom Morgan?"}

◊dialog{"Aye, aye,"} returned Morgan; ◊dialog{"I mind him; he owed me money, he did, and took my knife ashore with him."}

◊dialog{"Speaking of knives,"} said another, ◊dialog{"why don't we find his'n lying round? Flint warn't the man to pick a seaman's pocket; and the birds, I guess, would leave it be."}

◊dialog{"By the powers, and that's true!"} cried Silver.

◊dialog{"There ain't a thing left here,"} said Merry, still feeling round among the bones; ◊dialog{"not a copper doit nor a baccy box. It don't look nat'ral to me."}

◊dialog{"No, by gum, it don't,"} agreed Silver; ◊dialog{"not nat'ral, nor not nice, says you. Great guns! Messmates, but if Flint was living, this would be a hot spot for you and me. Six they were, and six are we; and bones is what they are now."}

◊dialog{"I saw him dead with these here deadlights,"} said Morgan. ◊dialog{"Billy took me in. There he laid, with penny-pieces on his eyes."}

◊dialog{"Dead--aye, sure enough he's dead and gone below,"} said the fellow with the bandage; ◊dialog{"but if ever sperrit walked, it would be Flint's. Dear heart, but he died bad, did Flint!"}

◊dialog{"Aye, that he did,"} observed another; ◊dialog{"now he raged, and now he hollered for the rum, and now he sang. 'Fifteen Men' were his only song, mates; and I tell you true, I never rightly liked to hear it since. It was main hot, and the windy was open, and I hear that old song comin' out as clear as clear--and the death-haul on the man already."}

◊dialog{"Come, come,"} said Silver; ◊dialog{"stow this talk. He's dead, and he don't walk, that I know; leastways, he won't walk by day, and you may lay to that. Care killed a cat. Fetch ahead for the doubloons."}
