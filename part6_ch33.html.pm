...
◊img[#:src "/images/0306m.png"]{}

◊img[#:src "/images/9306m.png" #:alt "T" #:class "drop-cap"]{}HERE never was such an overturn in this world. Each of these six men was as though he had been struck. But with Silver the blow passed almost instantly. Every thought of his soul had been set full-stretch, like a racer, on that money; well, he was brought up, in a single second, dead; and he kept his head, found his temper, and changed his plan before the others had had time to realize the disappointment.

◊dialog{"Jim,"} he whispered, ◊dialog{"take that, and stand by for trouble."}

And he passed me a double-barrelled pistol.

At the same time, he began quietly moving northward, and in a few steps had put the hollow between us two and the other five. Then he looked at me and nodded, as much as to say, ◊dialog{"Here is a narrow corner,"} as, indeed, I thought it was. His looks were not quite friendly, and I was so revolted at these constant changes that I could not forbear whispering, ◊dialog{"So you've changed sides again."}
...
◊dialog{"Two guineas!"} roared Merry, shaking it at Silver. ◊dialog{"That's your seven hundred thousand pounds, is it? You're the man for bargains, ain't you? You're him that never bungled nothing, you wooden-headed lubber!"}

◊dialog{"Dig away, boys,"} said Silver with the coolest insolence; ◊dialog{"you'll find some pig-nuts and I shouldn't wonder."}

◊dialog{"Pig-nuts!"} repeated Merry, in a scream. ◊dialog{"Mates, do you hear that? I tell you now, that man there knew it all along. Look in the face of him and you'll see it wrote there."}

◊dialog{"Ah, Merry,"} remarked Silver, ◊dialog{"standing for cap'n again? You're a pushing lad, to be sure."}
...
◊dialog{"Mates,"} says he, ◊dialog{"there's two of them alone there; one's the old cripple that brought us all here and blundered us down to this; the other's that cub that I mean to have the heart of. Now, mates--"}
...
◊dialog{"Forward!"} cried the doctor. ◊dialog{"Double quick, my lads. We must head 'em
off the boats."}
...
◊dialog{"Doctor,"} he hailed, ◊dialog{"see there! No hurry!"}
...
◊dialog{"Thank ye kindly, doctor,"} says he. ◊dialog{"You came in in about the nick, I guess, for me and Hawkins. And so it's you, Ben Gunn!"} he added. ◊dialog{"Well, you're a nice one, to be sure."}

◊dialog{"I'm Ben Gunn, I am,"} replied the maroon, wriggling like an eel in his embarrassment. ◊dialog{"And,"} he added, after a long pause, ◊dialog{"how do, Mr. Silver? Pretty well, I thank ye, says you."}

◊dialog{"Ben, Ben,"} murmured Silver, ◊dialog{"to think as you've done me!"}
...
◊dialog{"As for you, Jim,"} he said, ◊dialog{"it went against my heart, but I did what I thought best for those who had stood by their duty; and if you were not one of these, whose fault was it?"}
...
◊dialog{"Ah,"} said Silver, ◊dialog{"it were fortunate for me that I had Hawkins here. You would have let old John be cut to bits, and never given it a thought, doctor."}

◊dialog{"Not a thought,"} replied Dr. Livesey cheerily.
...
◊dialog{"John Silver,"} he said, ◊dialog{"you're a prodigious villain and imposter--a monstrous imposter, sir. I am told I am not to prosecute you. Well, then, I will not. But the dead men, sir, hang about your neck like mill-stones."}

◊dialog{"Thank you kindly, sir,"} replied Long John, again saluting.

◊dialog{"I dare you to thank me!"} cried the squire. ◊dialog{"It is a gross dereliction of my duty. Stand back."}
...
◊dialog{"Come in, Jim,"} said the captain. ◊dialog{"You're a good boy in your line, Jim, but I don't think you and me'll go to sea again. You're too much of the born favourite for me. Is that you, John Silver? What brings you here, man?"}

◊dialog{"Come back to my dooty, sir,"} returned Silver.

◊dialog{"Ah!"} said the captain, and that was all he said.
