...
◊a[#:href "/images/0298.jpg"]{◊img[#:class "chapter-img" #:src "/images/0298m.png"]{}}

◊a[#:href "/images/9298.jpg"]{◊img[#:src "/images/9298m.png" #:alt "P" #:class "drop-cap"]{}}ARTLY from the damping influence of this alarm, partly to rest Silver and the sick folk, the whole party sat down as soon as they had gained the brow of the ascent.
...
◊dialog{"There are three 'tall trees'"} said he, ◊dialog{"about in the right line from Skeleton Island. 'Spy-glass shoulder,' I take it, means that lower p'int there. It's child's play to find the stuff now. I've half a mind to dine first."}

◊dialog{"I don't feel sharp,"} growled Morgan. ◊dialog{"Thinkin' o' Flint--I think it were--as done me."}

◊dialog{"Ah, well, my son, you praise your stars he's dead,"} said Silver.

◊dialog{"He were an ugly devil,"} cried a third pirate with a shudder; ◊dialog{"that blue in the face too!"}

◊dialog{"That was how the rum took him,"} added Merry. ◊dialog{"Blue! Well, I reckon he was blue. That's a true word."}
...
Ever since they had found the skeleton and got upon this train of thought, they had spoken lower and lower, and they had almost got to whispering by now, so that the sound of their talk hardly interrupted the silence of the wood. All of a sudden, out of the middle of the trees in front of us, a thin, high, trembling voice struck up the well-known air and words:
     ...
     ◊poem{"Fifteen men on the dead man's chest--
...
◊dialog{"It's Flint, by ----!"} cried Merry.
...
◊dialog{"Come,"} said Silver, struggling with his ashen lips to get the word out; ◊dialog{"this won't do. Stand by to go about. This is a rum start, and I can't name the voice, but it's someone skylarking--someone that's flesh and blood, and you may lay to that."}
...
◊a[#:href "/images/0301.jpg"]{◊img[#:class "chapter-img" #:src "/images/0301m.png"]{}}
...
◊dialog{"That fixes it!"} gasped one. ◊dialog{"Let's go."}

◊dialog{"They was his last words,"} moaned Morgan, ◊dialog{"his last words above board."}
...
◊dialog{"Belay there, John!"} said Merry. ◊dialog{"Don't you cross a sperrit."}
...
◊dialog{"Sperrit? Well, maybe,"} he said. ◊dialog{"But there's one thing not clear to me. There was an echo. Now, no man ever seen a sperrit with a shadow; well then, what's he doing with an echo to him, I should like to know? That ain't in natur', surely?"}
...
◊dialog{"Well, that's so,"} he said. ◊dialog{"You've a head upon your shoulders, John, and no mistake. 'Bout ship, mates! This here crew is on a wrong tack, I do believe. And come to think on it, it was like Flint's voice, I grant you, but not just so clear-away like it, after all. It was liker somebody else's voice now--it was liker--"}

◊dialog{"By the powers, Ben Gunn!"} roared Silver.

◊dialog{"Aye, and so it were,"} cried Morgan, springing on his knees. ◊dialog{"Ben Gunn it were!"}

◊dialog{"It don't make much odds, do it, now?"} asked Dick. ◊dialog{"Ben Gunn's not here in the body any more'n Flint."}

But the older hands greeted this remark with scorn.

◊dialog{"Why, nobody minds Ben Gunn,"} cried Merry; ◊dialog{"dead or alive, nobody minds him."}
...
◊dialog{"I told you,"} said he--◊dialog{"I told you you had sp'iled your Bible. If it ain't no good to swear by, what do you suppose a sperrit would give for it? Not that!"} and he snapped his big fingers, halting a moment on his crutch.
...
◊dialog{"Huzza, mates, all together!"} shouted Merry; and the foremost broke into a run.
