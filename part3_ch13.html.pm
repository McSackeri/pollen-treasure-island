...
◊dialog{"Well,"} he said with an oath, ◊dialog{"it's not forever."}
...
◊dialog{"There's a strong scour with the ebb,"} he said, ◊dialog{"and this here passage
...
◊dialog{"I don't know about treasure,"} he said, ◊dialog{"but I'll stake my wig there's fever here."}
...
◊dialog{"Sir,"} said the captain, ◊dialog{"if I risk another order, the whole ship'll come about our ears by the run. You see, sir, here it is. I get a rough answer, do I not? Well, if I speak back, pikes will be going in two shakes; if I don't, Silver will see there's something under that, and the game's up. Now, we've only one man to rely on."}

◊dialog{"And who is that?"} asked the squire.

◊dialog{"Silver, sir,"} returned the captain; ◊dialog{"he's as anxious as you and I to smother things up. This is a tiff; he'd soon talk 'em out of it if he had the chance, and what I propose to do is to give him the chance. Let's allow the men an afternoon ashore. If they all go, why we'll fight the ship. If they none of them go, well then, we hold the cabin, and God defend the right. If some go, you mark my words, sir, Silver'll bring 'em aboard again as mild as lambs."}
...
◊dialog{"My lads,"} said he, ◊dialog{"we've had a hot day and are all tired and out of sorts. A turn ashore'll hurt nobody--the boats are still in the water; you can take the gigs, and as many as please may go ashore for the afternoon. I'll fire a gun half an hour before sundown."}
...
◊dialog{"Jim, Jim!"} I heard him shouting.
