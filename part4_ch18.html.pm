...
◊a[#:href "images/0175.jpg"]{◊img[#:class "chapter-img"  #:src "images/0175m.png"]{}}

◊a[#:href "images/9175.jpg"]{◊img[#:src "images/9175m.png" #:alt "W" #:class "drop-cap"]{}}E made our best speed across the strip of wood that now divided us from the stockade, and at every step we took the voices of the buccaneers rang nearer. Soon we could hear their footfalls as they ran and the cracking of the branches as they breasted across a bit of thicket.

I began to see we should have a brush for it in earnest and looked to my priming.

◊dialog{"Captain,"} said I, ◊dialog{"Trelawney is the dead shot. Give him your gun; his own is useless."}
...
◊dialog{"Be I going, doctor?"} he asked.

◊dialog{"Tom, my man,"} said I, ◊dialog{"you're going home."}

◊dialog{"I wish I had had a lick at them with the gun first,"} he replied.

◊dialog{"Tom,"} said the squire, ◊dialog{"say you forgive me, won't you?"}

◊dialog{"Would that be respectful like, from me to you, squire?"} was the answer. ◊dialog{"Howsoever, so be it, amen!"}

After a little while of silence, he said he thought somebody might read a prayer. ◊dialog{"It's the custom, sir,"} he added apologetically. And not long after, without another word, he passed away.
...
◊dialog{"Don't you take on, sir,"} he said, shaking the squire's hand. ◊dialog{"All's well with him; no fear for a hand that's been shot down in his duty to captain and owner. It mayn't be good divinity, but it's a fact."}

Then he pulled me aside.

◊dialog{"Dr. Livesey,"} he said, ◊dialog{"in how many weeks do you and squire expect the consort?"}

I told him it was a question not of weeks but of months, that if we were not back by the end of August Blandly was to send to find us, but neither sooner nor later. ◊dialog{"You can calculate for yourself,"} I said.

◊dialog{"Why, yes,"} returned the captain, scratching his head; ◊dialog{"and making a large allowance, sir, for all the gifts of Providence, I should say we were pretty close hauled."}

◊dialog{"How do you mean?"} I asked.

◊dialog{"It's a pity, sir, we lost that second load. That's what I mean,"} replied the captain. ◊dialog{"As for powder and shot, we'll do. But the rations are short, very short--so short, Dr. Livesey, that we're perhaps as well without that extra mouth."}
...
◊dialog{"Oho!"} said the captain. ◊dialog{"Blaze away! You've little enough powder already, my lads."}
...
◊dialog{"Captain,"} said the squire, ◊dialog{"the house is quite invisible from the ship. It must be the flag they are aiming at. Would it not be wiser to take it in?"}

◊dialog{"Strike my colours!"} cried the captain. ◊dialog{"No, sir, not I"}; and as soon as he had said the words, I think we all agreed with him. For it was not only a piece of stout, seamanly, good feeling; it was good policy besides and showed our enemies that we despised their cannonade.
...
◊dialog{"There is one good thing about all this,"} observed the captain; ◊dialog{"the wood in front of us is likely clear. The ebb has made a good while; our stores should be uncovered. Volunteers to go and bring in pork."}
...
◊dialog{"Somebody hailing us,"} said Hunter, who was on guard.

◊dialog{"Doctor! Squire! Captain! Hullo, Hunter, is that you?"} came the cries.

And I ran to the door in time to see Jim Hawkins, safe and sound, come climbing over the stockade.

◊a[#:href "images/0179.jpg"]{◊img[#:class "chapter-img" #:src "images/0179m.png"]{}}
