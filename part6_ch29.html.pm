...
◊a[#:href "/images/0271.jpg"]{◊img[#:class "chapter-img" #:src "/images/0271m.png"]{}}

◊a[#:href "/images/9271.jpg"]{◊img[#:src "/images/9271m.png" #:alt "T" #:class "drop-cap"]{}}HE council of buccaneers had lasted some time, when one of them re-entered the house, and with a repetition of the same salute, which had in my eyes an ironical air, begged for a moment's loan of the torch. Silver briefly agreed, and this emissary retired again, leaving us together in the dark.
...
◊a[#:href "/images/0273.jpg"]{◊img[#:class "chapter-img" #:src "/images/0273m.png"]{}}
...
◊dialog{"Well, let 'em come, lad--let 'em come,"} said Silver cheerily. ◊dialog{"I've still a shot in my locker."}
...
◊dialog{"Step up, lad,"} cried Silver. ◊dialog{"I won't eat you. Hand it over, lubber. I know the rules, I do; I won't hurt a depytation."}
...
◊dialog{"Yes,"} said one, ◊dialog{"that's Flint, sure enough. J. F., and a score below, with a clove hitch to it; so he done ever."}

◊dialog{"Mighty pretty,"} said George. ◊dialog{"But how are we to get away with it, and us no ship."}

Silver suddenly sprang up, and supporting himself with a hand against the wall: ◊dialog{"Now I give you warning, George,"} he cried. ◊dialog{"One more word of your sauce, and I'll call you down and fight you. How? Why, how do I know? You had ought to tell me that--you and the rest, that lost me my schooner, with your interference, burn you! But not you, you can't; you hain't got the invention of a cockroach. But civil you can speak, and shall, George Merry, you may lay to that."}

◊dialog{"That's fair enow,"} said the old man Morgan.

◊dialog{"Fair! I reckon so,"} said the sea-cook. ◊dialog{"You lost the ship; I found the treasure. Who's the better man at that? And now I resign, by thunder! Elect whom you please to be your cap'n now; I'm done with it."}

◊dialog{"Silver!"} they cried. ◊dialog{"Barbecue forever! Barbecue for cap'n!"}

◊dialog{"So that's the toon, is it?"} cried the cook. ◊dialog{"George, I reckon you'll have to wait another turn, friend; and lucky for you as I'm not a revengeful man. But that was never my way. And now, shipmates, this black spot? 'Tain't much good now, is it? Dick's crossed his luck and spoiled his Bible, and that's about all."}

◊dialog{"It'll do to kiss the book on still, won't it?"} growled Dick, who was evidently uneasy at the curse he had brought upon himself.

◊dialog{"A Bible with a bit cut out!"} returned Silver derisively. ◊dialog{"Not it. It don't bind no more'n a ballad-book."}

◊dialog{"Don't it, though?"} cried Dick with a sort of joy. ◊dialog{"Well, I reckon that's worth having too."}

◊dialog{"Here, Jim--here's a cur'osity for you,"} said Silver, and he tossed me the paper.

It was around about the size of a crown piece. One side was blank, for it had been the last leaf; the other contained a verse or two of Revelation--these words among the rest, which struck sharply home upon my mind: ◊dialog{"Without are dogs and murderers."} The printed side had been blackened with wood ash, which already began to come off and soil my fingers; on the blank side had been written with the same material the one word ◊dialog{"Depposed."} I have that curiosity beside me at this moment, but not a trace of writing now remains beyond a single scratch, such as a man might make with his thumb-nail.
