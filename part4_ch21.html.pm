...
◊img[#:src "/images/0198m.jpg"]{}

◊img[#:src "/images/9198m.jpg" #:alt "A" #:class "drop-cap"]{}S soon as Silver disappeared, the captain, who had been closely watching him, turned towards the interior of the house and found not a man of us at his post but Gray. It was the first time we had ever seen him angry.
...
◊dialog{"Hang them!"} said the captain. ◊dialog{"This is as dull as the doldrums. Gray, whistle for a wind."}

And just at that moment came the first news of the attack.

◊dialog{"If you please, sir,"} said Joyce, ◊dialog{"if I see anyone, am I to fire?"}

◊dialog{"I told you so!"} cried the captain.

◊dialog{"Thank you, sir,"} returned Joyce with the same quiet civility.
...
◊dialog{"Did you hit your man?"} asked the captain.

◊dialog{"No, sir,"} replied Joyce. ◊dialog{"I believe not, sir."}

◊dialog{"Next best thing to tell the truth,"} muttered Captain Smollett. ◊dialog{"Load his gun, Hawkins. How many should say there were on your side, doctor?"}

◊dialog{"I know precisely,"} said Dr. Livesey. ◊dialog{"Three shots were fired on this side. I saw the three flashes--two close together--one farther to the west."}

◊dialog{"Three!"} repeated the captain. ◊dialog{"And how many on yours, Mr. Trelawney?"}
...
◊dialog{"At 'em, all hands--all hands!"} he roared in a voice of thunder.
...
◊dialog{"Out, lads, out, and fight 'em in the open! Cutlasses!"} cried the captain.
...
◊dialog{"Round the house, lads! Round the house!"} cried the captain; and even in the hurly-burly, I perceived a change in his voice.
...
◊dialog{"Fire--fire from the house!"} cried the doctor. ◊dialog{"And you, lads, back into cover."}
...
◊dialog{"The captain's wounded,"} said Mr. Trelawney.

◊dialog{"Have they run?"} asked Mr. Smollett.

◊dialog{"All that could, you may be bound,"} returned the doctor; ◊dialog{"but there's five of them will never run again."}

◊dialog{"Five!"} cried the captain. ◊dialog{"Come, that's better. Five against three leaves us four to nine. That's better odds than we had at starting. We were seven to nineteen then, or thought we were, and that's as bad to bear."}*
