...
◊img[#:src "/images/0234m.png"]{}

◊img[#:src "/images/9234m.png" #:alt "I" #:class "drop-cap"]{} HAD scarce gained a position on the bowsprit when the flying jib flapped and filled upon the other tack, with a report like a gun. The schooner trembled to her keel under the reverse, but next moment, the other sails still drawing, the jib flapped back again and hung idle.
...
◊dialog{"Come aboard, Mr. Hands,"} I said ironically.

He rolled his eyes round heavily, but he was too far gone to express surprise. All he could do was to utter one word, ◊dialog{"Brandy."}
...
◊dialog{"Aye,"} said he, ◊dialog{"by thunder, but I wanted some o' that!"}

I had sat down already in my own corner and begun to eat.

◊dialog{"Much hurt?"} I asked him.

He grunted, or rather, I might say, he barked.

◊dialog{"If that doctor was aboard,"} he said, ◊dialog{"I'd be right enough in a couple of turns, but I don't have no manner of luck, you see, and that's what's the matter with me. As for that swab, he's good and dead, he is,"} he added, indicating the man with the red cap. ◊dialog{"He warn't no seaman anyhow. And where mought you have come from?"}

◊dialog{"Well,"} said I, ◊dialog{"I've come aboard to take possession of this ship, Mr. Hands; and you'll please regard me as your captain until further notice."}
...
◊img[#:src "/images/0237m.png"]{}

And again dodging the boom, I ran to the colour lines, handed down their cursed black flag, and chucked it overboard.

◊dialog{"God save the king!"} said I, waving my cap. ◊dialog{"And there's an end to Captain Silver!"}

He watched me keenly and slyly, his chin all the while on his breast.

◊dialog{"I reckon,"} he said at last, ◊dialog{"I reckon, Cap'n Hawkins, you'll kind of want to get ashore now. S'pose we talks."}

◊dialog{"Why, yes,"} says I, ◊dialog{"with all my heart, Mr. Hands. Say on."} And I went back to my meal with a good appetite.

◊dialog{"This man,"} he began, nodding feebly at the corpse ◊dialog{"--O'Brien were his name, a rank Irelander--this man and me got the canvas on her, meaning for to sail her back. Well, HE'S dead now, he is--as dead as bilge; and who's to sail this ship, I don't see. Without I gives you a hint, you ain't that man, as far's I can tell. Now, look here, you gives me food and drink and a old scarf or ankecher to tie my wound up, you do, and I'll tell you how to sail her, and that's about square all round, I take it."}

◊dialog{"I'll tell you one thing,"} says I: ◊dialog{"I'm not going back to Captain Kidd's anchorage. I mean to get into North Inlet and beach her quietly there."}

◊dialog{"To be sure you did,"} he cried. ◊dialog{"Why, I ain't sich an infernal lubber after all. I can see, can't I? I've tried my fling, I have, and I've lost, and it's you has the wind of me. North Inlet? Why, I haven't no ch'ice, not I! I'd help you sail her up to Execution Dock, by thunder! So I would."}
