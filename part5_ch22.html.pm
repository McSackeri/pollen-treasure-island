...
◊a[#:href "/images/0209.jpg"]{◊img[#:class "chapter-img" #:src "/images/0209m.png"]{}}

◊a[#:href "/images/9209.jpg"]{◊img[#:src "/images/9209m.png" #:alt "T" #:class "drop-cap"]{}}HERE was no return of the mutineers--not so much as another shot out of the woods. They had "got their rations for that day," as the captain put it, and we had the place to ourselves and a quiet time to overhaul the wounded and get dinner. Squire and I cooked outside in spite of the danger, and even outside we could hardly tell what we were at, for horror of the loud groans that reached us from the doctor's patients.
...
◊dialog{"Why, in the name of Davy Jones,"} said he, ◊dialog{"is Dr. Livesey mad?"}

◊dialog{"Why no,"} says I. ◊dialog{"He's about the last of this crew for that, I take it."}

◊dialog{"Well, shipmate,"} said Gray, ◊dialog{"mad he may not be; but if HE'S not, you mark my words, I am."}

◊dialog{"I take it,"} replied I, ◊dialog{"the doctor has his idea; and if I am right, he's going now to see Ben Gunn."}
...
◊a[#:href "/images/0213.jpg"]{◊img[#:class "chapter-img" #:src "/images/0213m.png"]{}}
