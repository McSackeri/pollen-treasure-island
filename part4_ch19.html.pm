...
◊img[#:src "/images/0182m.png"]{}

◊img[#:src "/images/9182m.png" #:alt "A" #:class "drop-cap"]{}S soon as Ben Gunn saw the colours he came to a halt, stopped me by the arm, and sat down.

◊dialog{"Now,"} said he, ◊dialog{"there's your friends, sure enough."}

◊dialog{"Far more likely it's the mutineers,"} I answered.

◊dialog{"That!"} he cried. ◊dialog{"Why, in a place like this, where nobody puts in but gen'lemen of fortune, Silver would fly the Jolly Roger, you don't make no doubt of that. No, that's your friends. There's been blows too, and I reckon your friends has had the best of it; and here they are ashore in the old stockade, as was made years and years ago by Flint. Ah, he was the man to have a headpiece, was Flint! Barring rum, his match were never seen. He were afraid of none, not he; on'y Silver--Silver was that genteel."}

◊dialog{"Well,"} said I, ◊dialog{"that may be so, and so be it; all the more reason that I should hurry on and join my friends."}

◊dialog{"Nay, mate,"} returned Ben, ◊dialog{"not you. You're a good boy, or I'm mistook; but you're on'y a boy, all told. Now, Ben Gunn is fly. Rum wouldn't bring me there, where you're going--not rum wouldn't, till I see your born gen'leman and gets it on his word of honour. And you won't forget my words; 'A precious sight (that's what you'll say), a precious sight more confidence'--and then nips him."}

And he pinched me the third time with the same air of cleverness.

◊dialog{"And when Ben Gunn is wanted, you know where to find him, Jim. Just wheer you found him today. And him that comes is to have a white thing in his hand, and he's to come alone. Oh! And you'll say this: 'Ben Gunn,' says you, 'has reasons of his own.'"}

◊dialog{"Well,"} said I, ◊dialog{"I believe I understand. You have something to propose, and you wish to see the squire or the doctor, and you're to be found where I found you. Is that all?"}

◊dialog{"And when? says you,"} he added. ◊dialog{"Why, from about noon observation to about six bells."}

◊dialog{"Good,"} said I, ◊dialog{"and now may I go?"}

◊dialog{"You won't forget?"} he inquired anxiously. ◊dialog{"Precious sight, and reasons of his own, says you. Reasons of his own; that's the mainstay; as between man and man. Well, then"}--still holding me--◊dialog{"I reckon you can go, Jim. And, Jim, if you was to see Silver, you wouldn't go for to sell Ben Gunn? Wild horses wouldn't draw it from you? No, says you. And if them pirates camp ashore, Jim, what would you say but there'd be widders in the morning?"}
...
I had soon told my story and began to look about me. The log-house was made of unsquared trunks of pine--roof, walls, and floor. The latter stood in several places as much as a foot or a foot and a half above the surface of the sand. There was a porch at the door, and under this porch the little spring welled up into an artificial basin of a rather odd kind--no other than a great ship's kettle of iron, with the bottom knocked out, and sunk ◊dialog{"to her bearings,"} as the captain said, among the sand.
...
◊dialog{"That man Smollett,"} he said once, ◊dialog{"is a better man than I am. And when I say that it means a deal, Jim."}

Another time he came and was silent for a while. Then he put his head on
one side, and looked at me.

◊dialog{"Is this Ben Gunn a man?"} he asked.

◊dialog{"I do not know, sir,"} said I. ◊dialog{"I am not very sure whether he's sane."}

◊dialog{"If there's any doubt about the matter, he is,"} returned the doctor. ◊dialog{"A man who has been three years biting his nails on a desert island, Jim, can't expect to appear as sane as you or me. It doesn't lie in human nature. Was it cheese you said he had a fancy for?"}

◊dialog{"Yes, sir, cheese,"} I answered.

◊dialog{"Well, Jim,"} says he, ◊dialog{"just see the good that comes of being dainty in your food. You've seen my snuff-box, haven't you? And you never saw me take snuff, the reason being that in my snuff-box I carry a piece of Parmesan cheese--a cheese made in Italy, very nutritious. Well, that's for Ben Gunn!"}
...
◊dialog{"So,"} he added, ◊dialog{"if we are not all shot down first they'll be glad to be packing in the schooner. It's always a ship, and they can get to buccaneering again, I suppose."}

◊dialog{"First ship that ever I lost,"} said Captain Smollett.
...
◊dialog{"Flag of truce!"} I heard someone say; and then, immediately after, with a cry of surprise, ◊dialog{"Silver himself!"}
