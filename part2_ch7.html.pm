...
◊dialog{"Redruth,"} said I, interrupting the letter, ◊dialog{"Dr. Livesey will not like that. The squire has been talking, after all."}

◊dialog{"Well, who's a better right?"} growled the gamekeeper. ◊dialog{"A pretty rum go if squire ain't to talk for Dr. Livesey, I should think."}
...
◊dialog{"Where are we?"} I asked.

◊dialog{"Bristol,"} said Tom. ◊dialog{"Get down."}
...
◊dialog{"Here you are,"} he cried, ◊dialog{"and the doctor came last night from London. Bravo! The ship's company complete!"}

◊dialog{"Oh, sir,"} cried I, ◊dialog{"when do we sail?"}

◊dialog{"Sail!"} says he. ◊dialog{"We sail tomorrow!"}
